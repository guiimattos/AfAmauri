...
public class controleAcademicoComentado {
 ...
 * 
 * Depois tudo e dividido por 100 porque os pesos foram digitados em
 * porcentagem.
 * 
 ...
 * Se o aluno nao foi aprovado, o programa verifica se a media e exatamente um
 * ponto abaixo da nota minima.
 * 
 * Exemplo:
 * Nota minima = 6
 * Recuperacao = 5
 ...
 * Se o aluno nao foi aprovado e tambem nao ficou de recuperacao, ele foi
 * reprovado.
 ...
 * 
 * RESUMO GERAL
 * O programa le os pesos das avaliacoes, valida se a soma e 100, le a nota
 * minima,
 * le a quantidade de alunos, armazena as notas em uma matriz, calcula a media
 * de
 * cada aluno, mostra a situacao individual e no final exibe as estatisticas da
 * turma.
 */
